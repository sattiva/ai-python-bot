...
| `/set tts` | `[provider] [voice] [speed] [audio_fx] [filter_target] [filter_enabled]` | Configure active TTS engine, voice identifier, speech speed multiplier, acoustic audio filters (warm_asmr, whisper, etc.), and speech text filters. |
